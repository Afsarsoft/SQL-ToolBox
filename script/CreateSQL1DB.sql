/***************************************************************************************************
File: CreateSQL1DB.sql
----------------------------------------------------------------------------------------------------
Create Date:    2021-03-01 (yyyy-mm-dd)
Description:    Create SQL DB SQL1 
****************************************************************************************************/
USE [master]
GO
...
CREATE DATABASE [SQL1]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'SQL1', FILENAME = N'C:\SQL\DATA\SQL1.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'SQL1_log', FILENAME = N'C:\SQL\DATA\SQL1_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
ALTER DATABASE [SQL1] SET QUERY_STORE = OFF
GO
